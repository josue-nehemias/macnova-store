        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 bg-white rounded-[28px] p-8 lg:p-12 shadow-sm">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 space-y-3 text-[16px] text-gray-700">
              <p>
                <span className="font-semibold text-black">Modelo:</span>{' '}
                {producto.modelo}
              </p>
              ...
              <p>
                <span className="font-semibold text-black">Almacenamiento:</span>{' '}
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <button className="bg-[#0071e3] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#005bb5] transition">
                Agregar al carrito
              </button>
